                    ...
                    <div class="col d-flex flex-row">
                        <div class="user_box ml-auto">
                            @if (Route::has('login'))
                                ...
                                @auth
                                   <div class="user_box user_box_link"><a href="{{ url('/home') }}">perfil</a></div>
                                @else
                                    <div class="user_box_login user_box_link"><a href="{{ route('login') }}">Login</a></div>
                                    <div class="user_box_register user_box_link"><a href="{{ route('register') }}">registro</a></div>
                                @endauth
            ...
            <div class="row intro_items">
                ...
                <div class="col-lg-4 intro_col">
                    <div class="intro_item">
                        ...
                        <div class="intro_item_background" style="background-image:url(imagenes/intro_1.jpg)"></div>
                ...
                <div class="col-lg-4 intro_col">
                    <div class="intro_item">
                        ...
                        <div class="intro_item_background" style="background-image:url(imagenes/intro_2.jpg)"></div>
                        <div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
                            <div class="intro_date">May 25th - June 01st</div>
                            <div class="button intro_button"><div class="button_bcg"></div><a href="#">see more<span></span><span></span><span></span></a></div>
                            <div class="intro_center text-center">
                ...
                <div class="col-lg-4 intro_col">
                    <div class="intro_item">
                        ...
                        <div class="intro_item_background" style="background-image:url(imagenes/intro_3.jpg)"></div>
                        <div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
                            <div class="intro_date">May 25th - June 01st</div>
                            <div class="button intro_button"><div class="button_bcg"></div><a href="#">see more<span></span><span></span><span></span></a></div>
                            <div class="intro_center text-center">
                    ...
                    <div class="footer_col">
                        ...
                        <div class="footer_content footer_contact">
                            <ul class="contact_info_list">
                                ...
                                <li class="contact_info_item d-flex flex-row">
                                    <div><div class="contact_info_icon"><img src="imagenes/planet-earth.svg" alt=""></div></div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todo los derechos reservados | Este sitio fué creado <i class="fa fa-heart-o" aria-hidden="true"></i> por <a href="https://github.com/francotapiac/DBD" target="_blank">Franco Tapia/Maximilano Arevalo</a>
