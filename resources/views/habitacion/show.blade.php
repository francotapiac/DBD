        ...
        <div class="row"> 
            ...
            <div class="col-lg-3 col-1680-4">
                <div class="offers_image_container">
                    ...
                    <div class="offer_name"><a href="{{action('HabitacionController@show', $habitacion->id_habitacion)}}">{{$habitacion->nombre}}</a></div>
                </div>
            </div>
            <div class="col-lg-8">
                <div class="offers_content">
                    <div class="offers_price">${{$habitacion->costo}}</div>
                    <p class="offers_text">{{$habitacion->descripcion}}</p>
